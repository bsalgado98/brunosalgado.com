...
export const EXPERIENCE_TEXT = "my_experiences.html"
            ...
            <div className="App">
                ...
                <div id="app-space">
                    {this.state.appFrameVisible ? (
                        <AppFrame
                            app={this.state.currentApp.app}
                            icon={this.state.currentApp.icon}
                            exitApp={this.exit}
                        />
                    ) : null}
                </div>
                <div id="desktop" onClick={this.clickDesktop}>
                    ...
                    {this.state.startMenuVisible ? (
                        <StartMenu
                            close={this.closeStartMenu}
                            openStartMenuApp={this.open}
                        ></StartMenu>
                    ) : null}
                </div>
                <Taskbar
                    open={this.openStartMenu}
                    currentTaskText={this.state.currentApp.app}
                    currentTaskIcon={this.state.currentApp.icon}
                    startButtonActivated={this.state.startMenuVisible}
